...
import org.taonaw.studio_reservation.usecase.command.staff.exception.StaffAccountDuplicatedException;
...
public class RegisterMemberAccountService {
    ...
    public void handle(RegisterMemberAccountCommand command) {
