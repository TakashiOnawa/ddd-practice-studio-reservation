...
## ビジネスコンテキスト
- 現状のトップレベルの業務を明らかにする。
- 最初から全てを明らかにするのは難しいため、メインとなる業務をヒアリングしていく中で徐々に明らかにしてくと良い。
...
# システムコンテキスト（システム化の目的）
- 業務フローやヒアリングした内容から問題点を洗い出し、システム化の目的を決定する。

## 現状の問題点
- スタッフは、受付やスタジオの転換で忙しいにもかかわらず予約の対応をしなければならない。
- スタッフの負荷が高くなってしまうし、スタッフを増やすと人件費も嵩んでしまう。
- 利用者としても電話や店頭でしか予約できず不便である。

## システム化の目的
![](./modeling/SystemContext/SystemContext.png)

# 要求モデル
- システム化の目的を実現することにつながりそうなことを挙げてゆき、そこから重要なものに絞り込む。（要望、要求）
  - 理由をセットにすると分かりやすい。
- 要求、要求をシステムで実現するもの「XXXできること」として表現する（要件）

## 要望、要求
- 利用者が Web からも予約できると良い。
  - 電話や店頭での予約業務を少しでも減らせることで、スタッフの負荷が下がるし人数も減らせる。
- スタジオの空き、レンタル機材の空きを確認できると良い。
  - 電話や店頭での予約の際に予約可能かどうかの確認を効率化できる。
- 予約の詳細な内容を確認できると良い。
  - 転換作業を効率化できる。
- 利用料金の計算ができると良い。
  - 料金計算の手間を省けるし、間違いも減る。
...
- 利用者は、予約内容を変更できなければならない。
- 利用者は、予約をキャンセルできなければならない。
- スタッフは、電話や店頭での予約に対応するため、利用者と同じように Web で予約できなければならない。
  - 予約内容の変更、予約のキャンセルもできなければならない。
- スタッフは、電話や店頭での予約に対応するため、スタジオの空き状況を確認できなければならない。
- スタッフは、電話や店頭での予約に対応するため、レンタル機材の空き状況を確認できなければならない。
- スタッフは、スタジオの転換を行うため、予約の詳細な内容を確認できなければならない。
- システムは、利用料金を計算できなければならない。
- システムは、キャンセル料金を計算できなければならない。

- 利用者は、システムを利用するために利用者アカウントを登録できなければならない。
  - システムにログインするためには、メールアドレスとパスワードが一致しなければならない。
- スタッフ、システムを利用するためにスタッフアカウントを登録できなければならない。
...
- 練習区分ごとに最大利用人数を決められる。（個人練習の最大利用人数は 2 名までなど。）
- 練習区分ごとに予約受付開始日時を決められる。（個人練習は前日 21 時から、バンド練習は 2 ヶ月前からなど。）
...
- 変更可否は以下のルールとする。
  ...
  - 利用日時の変更
    ...
    - キャンセル料金が発生する場合
      - 時間を増やすことは可能。
      - 時間を減らすことは可能だが、減らした時間分のキャンセル料金が発生する。
