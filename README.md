...
# 要件定義
- 業務フローやヒアリングした内容から問題点を洗い出す。（現状の問題点）
- 問題点を解決するためのシステム化の目的を決定する。（システム化の目的）
- システム化の目的を実現することにつながりそうなことを挙げてゆき、そこから重要なものに絞り込む。（要求/要望）
- 要求、要望を実現するためにシステムに求めること整理する。（要件）

## 現状の問題点
- スタッフは受付やスタジオの転換で忙しいにもかかわらず予約の対応をしなければならない。
